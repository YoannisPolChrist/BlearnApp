# Verfügbare Slash-Commands (Skills)

Hier ist die Liste aller verfügbaren Agent-Skills, die du direkt über den /-Befehl aufrufen kannst:


- **/00-andruia-consultant**:
  "Arquitecto de Soluciones Principal y Consultor TecnolÃ³gico de Andru.ia. Diagnostica y traza la hoja de ruta Ã³ptima para proyectos de IA en espaÃ±ol."

- **/10-andruia-skill-smith**:
  "Ingeniero de Sistemas de Andru.ia. DiseÃ±a, redacta y despliega nuevas habilidades (skills) dentro del repositorio siguiendo el EstÃ¡ndar de Diamante."

- **/20-andruia-niche-intelligence**:
  "Estratega de Inteligencia de Dominio de Andru.ia. Analiza el nicho especÃ­fico de un proyecto para inyectar conocimientos, regulaciones y estÃ¡ndares Ãºnicos del sector. ActÃ­valo tras definir el nicho."
...
- **/crypto-bd-agent**:
  Autonomous crypto business development patterns â€” multi-chain token discovery, 100-point scoring with wallet forensics, x402 micropayments, ERC-8004 on-chain identity, LLM cascade routing, and...
...
- **/d3**:
  "Build custom, bespoke data visualizations with D3.js (Data-Driven Documents). The low-level, SVG-based approach to any chart imaginable. Use when Tremor/ECharts lack control, or when building animated, custom, or mathematical visualizations."
...
- **/data-structure-protocol**:
  "Give agents persistent structural memory of a codebase â€” navigate dependencies, track public APIs, and understand why connections exist without re-reading the whole repo."
...
- **/drizzle-orm-expert**:
  "Expert in Drizzle ORM for TypeScript â€” schema design, relational queries, migrations, and serverless database integration. Use when building type-safe database layers with Drizzle."
...
- **/echarts**:
  "Build powerful, interactive charts using Apache ECharts. Use when you need complex charts (bar, line, pie, scatter, heatmap, tree, radar, gauge, candlestick), rich interactivity, large datasets, or mobile-first charts."
...
- **/form-cro**:
  Optimize any form that is NOT signup or account registration â€” including lead capture, contact, demo request, application, survey, quote, and checkout forms.
...
- **/gemini-3-pro-coder**:
  Specialist for coding with Gemini 3.1 Pro. Use this skill when the user explicitly requests Gemini 3 models or high-end reasoning.
...
- **/lightning-factory-explainer**:
  Explain Bitcoin Lightning channel factories and the SuperScalar protocol â€” scalable Lightning onboarding using shared UTXOs, Decker-Wattenhofer trees, timeout-signature trees, MuSig2, and Taproot. No soft fork required.
...
- **/motion-react-animations**:
  "Expert patterns for the motion library (motiondivision/motion, formerly Framer Motion). Use when adding premium web animations to React or React Native (Expo) apps â€” enter/exit, gestures, scroll, layout, and shared element transitions. On React Native use in combination with moti/reanimated for cross-platform."
...
- **/nerdzao-elite-gemini-high**:
  "Modo Elite Coder + UX Pixel-Perfect otimizado especificamente para Gemini 3.1 Pro High. Workflow completo com foco em qualidade mÃ¡xima e eficiÃªncia de tokens."
...
- **/odoo-migration-helper**:
  "Step-by-step guide for migrating Odoo custom modules between versions (v14â†’v15â†’v16â†’v17). Covers API changes, deprecated methods, and view migration."
...
- **/odoo-purchase-workflow**:
  "Expert guide for Odoo Purchase: RFQ â†’ PO â†’ Receipt â†’ Vendor Bill workflow, purchase agreements, vendor price lists, and 3-way matching."
...
- **/project-patterns-therapyclient**:
  "Project specific patterns and technical designs for the TherapyClientApp"
...
- **/terraform-aws-modules**:
  "Terraform module creation for AWS â€” reusable modules, state management, and HCL best practices. Use when building or reviewing Terraform AWS infrastructure."
...
- **/tremor**:
  "Build beautiful React chart components and dashboards with Tremor. Copy-paste components built on Recharts and Tailwind CSS. Use for BarChart, LineChart, AreaChart, DonutChart, ScatterChart, and KPI cards."
...
- **/vizzu-lib**:
  "Build animated data visualizations and interactive data stories using Vizzu. Use when creating charts, graphs, and animating transitions between different data perspectives."
